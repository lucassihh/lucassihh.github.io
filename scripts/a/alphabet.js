...
function setupAlphabet(allAlphabetData, language) {
  ...
  function generateAlphabetGrid() {
    currentAlphabet.letters.forEach((item, index) => {
      ...
      button.className = `
        letter-button relative p-2 rounded-xl
        text-primary font-semibold text-xl
        hover:scale-105 hover:text-purple-400 transition-colors
      `;
        ...
        ${letterData.examples
          .map(
            ...
            <div class="flex flex-col gap-2">
              ...
              <div class="bg-card p-3 rounded-lg m-2">
