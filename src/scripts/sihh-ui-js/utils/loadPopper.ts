...
let popperReady: Promise<typeof import("@popperjs/core") | undefined> | null =
  null; // Promise to handle loading Popper.js once
...
export function loadPopperJs(): Promise<
  typeof import("@popperjs/core") | undefined
> {
  if (popperLoaded) {
