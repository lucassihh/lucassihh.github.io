    ...
    <div id="flashcards-modal" class="modal fixed inset-0 flex items-center justify-center z-[100] hidden px-4">
      ...
      <div class="modal-dialog w-full max-w-2xl relative flex flex-col gap-8 p-8 bg-background rounded-xl border border-border shadow-sm transition-all duration-300">
        ...
        <div class="flex items-center justify-between">
          ...
          <button data-modal-close class="size-12 flex items-center justify-center rounded-full bg-slate-50 dark:bg-zinc-800 text-slate-400 hover:text-black dark:hover:text-white transition-colors">
            ${ICONS.close}
          </button>
        </div>
